...
## 5. Business Requirements ⏳ (INPUT — รอเจ้าของผลิตภัณฑ์)

> กรอกตามรูปแบบนี้ (เท่าที่มี) แล้วผมจะ map เข้ากับ Capacity Map §4 + ออกแบบให้อยู่ในกรอบสถาปัตยกรรม

```
เป้าหมายธุรกิจ / metric ที่อยากขยับ:
  - …

กลุ่มผู้ใช้เป้าหมาย:
  - …

Features ที่ต้องการ (ใส่ได้หลายอัน):
  - ชื่อฟีเจอร์:
    user story: "ในฐานะ … ฉันอยาก … เพื่อ …"
    priority: P1 / P2 / P3
    acceptance: …
...
Timeline / budget (ถ้ามี):
  - …
```

*(ส่วนนี้ว่างไว้รอ input — เมื่อได้ requirement ผมจะเติม §6)*

---

## 6. Feature Backlog & Roadmap 🧩 (derive จาก §5 — ยังว่าง)

> จะเติมหลังได้ business requirement: แต่ละ feature → ระบุ fit กับ §4, ส่วนที่ต้องต่อเติม, effort, ลำดับ
